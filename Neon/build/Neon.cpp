...
class config{
    public:
        //NOTE - Using This will significantly reduce performance
        bool show_parsed_files = false;

        //Saved file name
        std::string outfilename = "out.scene";

        //Save the Output Recommended
        bool save_file = true ;
};
...
int main(){
    ...
    //File stuff
    std::ifstream file;
    std::ofstream outfile(Config.outfilename);
    std::string filename;
    ...
    */
        if (Config.show_parsed_files == true){
            std::cout << "Object{" << "\n"
    ...
    //show the objs
    std::cout << "Parsed : " <<parsed_objs << " Objects" << std::endl;
    // End timer
